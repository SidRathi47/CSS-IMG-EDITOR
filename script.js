...
function imageOutput() {
  ...
  if(shadow){
      filterSettings += "drop-shadow("+hShadow +"px "+  vShadow + "px " + blurShadow +"px "+
       colorShadow+")"; 
 }
...
function setHueRotation() {
 hueRotation = document.getElementById(
  "hue").value;
...
function setSaturation() {
 saturation = document.getElementById(
  "saturate").value;
 document.getElementById(
